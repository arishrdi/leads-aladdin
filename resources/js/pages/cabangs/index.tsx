...
import { AlertTriangle, Building, Edit, Eye, Grid, List, MapPin, Phone, Plus, Trash2, User, Users } from 'lucide-react';
                        ...
                        {cabangs.map((cabang) => (
                            <Card key={cabang.id} className="transition-shadow hover:shadow-md">
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    {/* Stats */}
                                    <div className="grid grid-cols-2 gap-4 border-t border-gray-100 py-3">
                                        <div className="text-center">
                                            <div className="text-lg font-bold text-[#2B5235]">{cabang.users_count}</div>
                                            <div className="text-xs text-gray-500">Marketing</div>
                                        </div>
