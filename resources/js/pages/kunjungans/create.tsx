...
export default function CreateKunjungan() {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        waktu_canvasing: new Date().toISOString().split('T')[0],
        bertemu_dengan: '',
        nomor_aktif_takmir: '',
        nama_masjid: '',
        alamat_masjid: '',
        ...
        kebutuhan: '',
        catatan: '',
        item_responses: {} as Record<string, string>,
    });
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Tambah Kunjungan - Leads Aladdin" />
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-brand-primary">Tambah Kunjungan</h1>
                        <p className="text-muted-foreground">
                            Catat detail kunjungan ke masjid/instansi
                        </p>
                    </div>
                </div>
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <Card className="border-border/50 shadow-soft">
                        ...
                        <CardContent>
                            <div>
                                <Label htmlFor="foto_masjid">Foto Masjid</Label>
                                <div className="mt-2">
                                    <Input
                                        id="foto_masjid"
                                        type="file"
