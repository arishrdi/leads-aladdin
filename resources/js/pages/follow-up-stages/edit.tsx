...
export default function EditFollowUpStage() {
    const { stage, availableStages } = usePage<Props>().props;
    
    const { data, setData, patch, processing, errors } = useForm({
        key: stage.key,
        name: stage.name,
        next_stage_key: stage.next_stage_key || 'null',
    ...
    const submit: FormEventHandler = (e) => {
        ...
        patch(`/follow-up-stages/${stage.id}`, submitData);
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Edit Tahap: ${stage.name}`} />
                                    ...
                                    >
                                        ...
                                        <SelectContent>
                                            ...
                                            {availableStages.map((availableStage) => (
                                                <SelectItem key={availableStage.key} value={availableStage.key}>
                                                    {availableStage.name} ({availableStage.key})
                                                </SelectItem>
                                            ))}
                                        </SelectContent>
                                    </Select>
